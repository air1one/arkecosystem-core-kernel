...
export interface Blockchain {
     ...
     * @return {void}
     */
    boot(skipStartedCheck: any): Promise<boolean>;
     ...
     */
    handleIncomingBlock(block: Interfaces.IBlockData, fromForger: any): void;
    enqueueBlocks(blocks: Interfaces.IBlockData[]): any;
    /**
     ...
     */
    processBlocks(blocks: Interfaces.IBlockData[], callback: any): Promise<Interfaces.IBlock[] | undefined>;
    /**
     ...
     * Push ping block.
     */
    pushPingBlock(block: Interfaces.IBlockData, fromForger: any): void;
}
