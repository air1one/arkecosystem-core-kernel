...
import { ListOptions, ListOrder, ListPage, ListResult, OrContainsCriteria, OrCriteria, OrEqualCriteria, OrLikeCriteria, OrNumericCriteria } from "../search";
export declare type TransactionCriteria = {
...
export declare type OrTransactionCriteria = OrCriteria<TransactionCriteria>;
export declare type TransactionDataWithBlockData = {
...
export interface TransactionHistoryService {
    ...
    listByCriteria(criteria: OrTransactionCriteria, order: ListOrder, page: ListPage, options?: ListOptions): Promise<ListResult<Interfaces.ITransactionData>>;
    ...
    listByCriteriaJoinBlock(criteria: OrTransactionCriteria, order: ListOrder, page: ListPage, options?: ListOptions): Promise<ListResult<TransactionDataWithBlockData>>;
}
